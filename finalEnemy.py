...
class FinalEnemy:
    ...
    def __init__(self, gabby, temp_x, temp_y, temp_speed, temp_bool, temp_color, bar_state):
        ...
        self.finalBossHealth = [
            "sprites\\environment-stuff\\final-bar\\full-6.png",
            "sprites\\environment-stuff\\final-bar\\full-5.5.png",
            "sprites\\environment-stuff\\final-bar\\full-2.png",
            "sprites\\environment-stuff\\final-bar\\full-3.png",
            "sprites\\environment-stuff\\final-bar\\full-4.png",
            "sprites\\environment-stuff\\final-bar\\full-5.png"
    ...
    def draw(self, screen):
        ...
        if 60 >= self.hitpoints >= 50:
            screen.blit(pygame.image.load(self.finalBossHealth[0]), ((self.bar_mult + 740), 25))
        elif 50 >= self.hitpoints >= 40:
            screen.blit(pygame.image.load(self.finalBossHealth[1]), ((self.bar_mult + 740), 25))
        elif 40 >= self.hitpoints >= 30:
            screen.blit(pygame.image.load(self.finalBossHealth[2]), ((self.bar_mult + 740), 25))
        elif 30 >= self.hitpoints >= 20:
            screen.blit(pygame.image.load(self.finalBossHealth[3]), ((self.bar_mult + 740), 25))
        elif 20 >= self.hitpoints:
            screen.blit(pygame.image.load(self.finalBossHealth[4]), ((self.bar_mult + 740), 25))
