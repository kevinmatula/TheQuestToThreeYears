...
class LevelOneD:
    def __init__(self, screen, gameStateManager, clock):
        ...
        self.enemy1 = Enemy(self.gabby, random.randint(400, 1400), 900, 10, True, (123,104,238))
        ...
        self.enemy5 = Enemy(self.gabby, random.randint(400, 1400), 900, 10, True, (123,104,238))
        self.enemy6 = Enemy(self.gabby, random.randint(400, 1400), 900, 2, False, (0, 0, 0))
        self.enemy7 = Enemy(self.gabby, random.randint(900, 1400), 900, 10, True, (123,104,238))
        self.enemy8 = Enemy(self.gabby, 620, 500, 0, False, (0, 0, 0))
        ...
        self.blocks = [(self.floor_block, (self.mult_64 * 10), 650),
