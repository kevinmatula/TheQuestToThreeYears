...
class LevelOneC:
    def __init__(self, screen, gameStateManager, clock):
        ...
        self.enemy1 = Enemy(self.gabby, random.randint(400, 1400), 900, 1, False, (0, 0, 0))
        self.enemy2 = Enemy(self.gabby, random.randint(400, 1400), 900, 8, False, (0, 0, 0))
        self.enemy3 = Enemy(self.gabby, random.randint(400, 1400), 900, random.randint(1, 3), False, (0, 0, 0))
        self.enemy4 = Enemy(self.gabby, random.randint(400, 1400), 900, 6, False, (0, 0, 0))
        self.enemy5 = Enemy(self.gabby, random.randint(400, 1400), 900, 5, False, (0, 0, 0))
        self.enemy6 = Enemy(self.gabby, random.randint(400, 1400), 900, 2, False, (0, 0, 0))
        self.enemy7 = Enemy(self.gabby, random.randint(900, 1400), 900, 9, False, (0, 0, 0))
        self.enemy8 = Enemy(self.gabby, random.randint(900, 1400), 900, 9, False, (0, 0, 0))
        self.enemy9 = Enemy(self.gabby, random.randint(400, 1400), 900, 1, False, (0, 0, 0))
        self.enemy10 = Enemy(self.gabby, random.randint(400, 1400), 900, 3, False, (0, 0, 0))
        self.enemy11 = Enemy(self.gabby, random.randint(400, 1400), 900, 3, False, (0, 0, 0))
        self.enemy12 = Enemy(self.gabby, random.randint(400, 1400), 900, 3, False, (0, 0, 0))

        self.enemies = [self.enemy1, self.enemy2, self.enemy3, self.enemy4,
                        self.enemy5, self.enemy6, self.enemy7, self.enemy8,
                        self.enemy9, self.enemy10, self.enemy11, self.enemy12]
        self.cats = []
        self.env = Env()
        self.mult_64 = 64
        ...
        self.blocks = [##the first row are the silly blocks
            ...
            (self.floor_block, (self.mult_64 *  9), 650), (self.floor_block, (self.mult_64 *  10), 650),
            (self.floor_block, (self.mult_64 * 17), 650), (self.floor_block, (self.mult_64 * 18), 650),
            (self.floor_block, (self.mult_64 *  0), 925), (self.floor_block, (self.mult_64 *  1), 925),
            (self.floor_block, (self.mult_64 * 4), 1053), (self.floor_block, (self.mult_64 * 5), 1053),
            (self.floor_block, (self.mult_64 * 6), 1053), (self.floor_block, (self.mult_64 * 7), 1053),
            (self.floor_block, (self.mult_64 * 8), 1053), (self.floor_block, (self.mult_64 * 9), 1053),
            (self.floor_block, (self.mult_64 * 10), 1053), (self.floor_block, (self.mult_64 * 11), 1053),
            (self.floor_block, (self.mult_64 * 12), 1053), (self.floor_block, (self.mult_64 * 13), 1053),
            (self.floor_block, (self.mult_64 * 14), 1053), (self.floor_block, (self.mult_64 * 15), 1053),
            (self.floor_block, (self.mult_64 * 16), 1053), (self.floor_block, (self.mult_64 * 17), 1053),
            (self.floor_block, (self.mult_64 * 18), 1053), (self.floor_block, (self.mult_64 * 19), 1053),
            (self.floor_block, (self.mult_64 * 20), 1053), (self.floor_block, (self.mult_64 * 21), 1053),
            (self.floor_block, (self.mult_64 * 22), 1053), (self.floor_block, (self.mult_64 * 23), 1053),
            (self.floor_block, (self.mult_64 * 24), 1053), (self.floor_block, (self.mult_64 * 25), 1053),
            (self.floor_block, (self.mult_64 * 28), 925), (self.floor_block, (self.mult_64 * 29), 925),
            ## these are important corner blocks which must be registered last
            (self.floor_block, (self.mult_64 * 3), 989), (self.floor_block, (self.mult_64 * 2), 925),
            (self.floor_block, (self.mult_64 * 26), 989), (self.floor_block, (self.mult_64 * 27), 925)]
