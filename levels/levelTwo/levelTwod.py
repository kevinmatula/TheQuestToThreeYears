...
from finalEnemy import FinalEnemy
import random
...
class LevelTwoD:
    def __init__(self, screen, gameStateManager, clock):
        ...
        self.enemy1 = FinalEnemy(self.gabby, 400, 925, 4, True, (123, 104, 238), 0)
        self.enemy2 = FinalEnemy(self.gabby, 800, 925, 8, True, (123, 104, 238), 200)
        self.enemy3 = FinalEnemy(self.gabby, 1000, 925, 12, True, (123, 104, 238), 400)
