...
class LevelTwoC:
    def __init__(self, screen, gameStateManager, clock):
        ...
        self.enemy1 = Enemy(self.gabby, 400, 925, 11, True, (123, 104, 238))
        self.enemy2 = Enemy(self.gabby, 400, 925, 9, False, (123, 104, 238))
        self.enemy3 = Enemy(self.gabby, 300, 925, 5, False, (0, 0, 0))
        self.enemy4 = Enemy(self.gabby, 850, 180, 11, True, (123, 104, 238))
        self.enemy7 = Enemy(self.gabby, 1600, 180, 10, True, (123, 104, 238))
        self.enemy8 = Enemy(self.gabby, 600, 200, 0, False, (0, 0, 0))
        self.enemy11 = Enemy(self.gabby, 1800, 150, 0, False, (0, 0, 0))
        self.enemy12 = Enemy(self.gabby, 1700, 925, 11, True, (123, 104, 238))
        self.enemy13 = Enemy(self.gabby, 1600, 925, 12, True, (123, 104, 238))
        self.enemy14 = Enemy(self.gabby, 1500, 925, 13, True, (123, 104, 238))
        self.enemy15 = Enemy(self.gabby, 1400, 925, 14, True, (123, 104, 238))
        self.enemy16 = Enemy(self.gabby, 1300, 925, 15, True, (123, 104, 238))
        self.enemy17 = Enemy(self.gabby, 1200, 925, 9, True, (123, 104, 238))
        self.enemy18 = Enemy(self.gabby, 1100, 925, 10, True, (123, 104, 238))
        self.enemy19 = Enemy(self.gabby, 1000, 925, 16, True, (123, 104, 238))
        self.enemies = [self.enemy1, self.enemy2, self.enemy3, self.enemy4, self.enemy7,
                        self.enemy8, self.enemy11, self.enemy12, self.enemy13, self.enemy14,
                        self.enemy15, self.enemy16, self.enemy17, self.enemy18, self.enemy19]
        self.cats = []
        self.env = Env()
        self.mult_64 = 64
        ...
        self.blocks = [
            ...
            (self.floor_block, 0, 600), (self.floor_block, (self.mult_64 * 1), 600),
            ...
            (self.floor_block, (self.mult_64 *  8), 925),
            #corner blocks
            (self.floor_block, (self.mult_64 * 20), 300),

            (self.floor_block, (self.mult_64 * 10), 669), (self.floor_block, (self.mult_64 * 11), 669),
            (self.floor_block, (self.mult_64 * 9), 925),
            ...
            (self.floor_block, (self.mult_64 * 10), 466), (self.floor_block, (self.mult_64 * 9), 466),
            (self.floor_block, (self.mult_64 * 15), 400), (self.floor_block, (self.mult_64 * 16), 400),
            (self.floor_block, (self.mult_64 * 25), 200), (self.floor_block, (self.mult_64 * 26), 200),
            (self.floor_block, (self.mult_64 * 27), 200), (self.floor_block, (self.mult_64 * 28), 200),
            (self.floor_block, (self.mult_64 * 29), 200), (self.floor_block, (self.mult_64 * 30), 402)
            ]
