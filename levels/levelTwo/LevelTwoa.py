...
class LevelTwoA:
    def __init__(self, screen, gameStateManager, clock):
        ...
        self.enemy7 = Enemy(self.gabby, 1400, 250, 0, False, (0, 0, 0))
        ...
        self.blocks = [(self.floor_block, (self.mult_64 *  20), 375), (self.floor_block, (self.mult_64 *  21), 375),
            (self.floor_block, (self.mult_64 *  22), 375), (self.floor_block, (self.mult_64 *  23), 375),
            (self.floor_block, (self.mult_64 *  24), 375), (self.floor_block, (self.mult_64 *  25), 375),
            (self.floor_block, (self.mult_64 *  26), 375), (self.floor_block, (self.mult_64 *  27), 375),
            (self.floor_block, (self.mult_64 *  28), 375), (self.floor_block, (self.mult_64 *  29), 375),
            (self.floor_block, (self.mult_64 *  30), 375),

            (self.floor_block, (self.mult_64 *  18), 650), (self.floor_block, (self.mult_64 *  19), 650),
            (self.floor_block, (self.mult_64 *  20), 650), (self.floor_block, (self.mult_64 *  21), 650),
            (self.floor_block, (self.mult_64 *  22), 650), (self.floor_block, (self.mult_64 *  23), 650),
            (self.floor_block, (self.mult_64 *  24), 650), (self.floor_block, (self.mult_64 *  25), 650),
            (self.floor_block, (self.mult_64 *  26), 650), (self.floor_block, (self.mult_64 *  27), 650),
            (self.floor_block, (self.mult_64 *  28), 650), (self.floor_block, (self.mult_64 *  29), 650),
            (self.floor_block, (self.mult_64 *  30), 650),
